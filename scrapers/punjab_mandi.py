...
TARGET_CROPS = [
    "Wheat", "Seed Cotton(Phutti)", "Rice Basmati Super (Old)",
    "Potato Fresh", "Tomato", "Onion", "Maize", "sugarcane(گنڈ یری)",
    "Gandum", "Kapas", "Chawal", "Ginger (Thai)", "Garlic (Local)",
    "Green Chilli", "Lady Finger/Okra (بھنڈی توری)"
]

TARGET_CITIES = ["lahore", "faisalabad", "rawalpindi", "multan", "okara", "islamabad", "peshawar", "karachi"]

FALLBACK_PRICES = [
    {"crop": "Gandum (Wheat)", "city": "Lahore", "min_price": "3200", "max_price": "3400", "unit": "per 40kg"},
    {"crop": "Gandum (Wheat)", "city": "Faisalabad", "min_price": "3150", "max_price": "3350", "unit": "per 40kg"},
    {"crop": "Kapas (Cotton)", "city": "Multan", "min_price": "8500", "max_price": "9200", "unit": "per 40kg"},
    {"crop": "Chawal (Rice)", "city": "Gujranwala", "min_price": "4200", "max_price": "4800", "unit": "per 40kg"},
]
